...
class LIQUIDITYGAUGEV3Client {
  ...
  public async setRewards(
    ...
    const runtimeArgs = RuntimeArgs.fromMap({
      ...
      claim_sig:CLValueBuilder.u256(claimSig), //issue
      reward_tokens: CLValueBuilder.list(rewardTokens.map(id => CLValueBuilder.string(id))), //issue
