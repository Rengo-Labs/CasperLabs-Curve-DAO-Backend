  ...
  try {
    ...
    rp(requestOptions)
      .then((response) => {
        ...
        let data = {};
        let symbols = req.body.symbol.split(",")
        symbols.forEach(symbol => {
            if(symbol)
            data[symbol] = {
                worth : response.data[symbol][0].quote.USD.price,
                worthforamountpassed : req.body.amount * response.data[symbol][0].quote.USD.price
            }
        })
